...
* description — краткое описание файла, органичено одинм 1024 символами

Отличить фэху от строчки файла очень просто по наличию ":". В имени файлэхи этот символ недопустим.

Так же метод поддерживает сокращённый индекс подобно расширенной схеме u/e. Например
...
* path — строка авторизации поинта
